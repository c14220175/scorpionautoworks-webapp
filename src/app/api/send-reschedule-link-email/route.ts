                  ...
                  <tr>
                    <td bgcolor="#ffffff" style="background-color: #ffffff; padding: 32px 24px;">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                        <tr>
                          <td bgcolor="#ffffff" style="background-color: #ffffff; border-left: 4px solid #10b981; padding: 24px; border-radius: 4px; text-align: center; border: 1px solid #e2e8f0;">
                            ...
                            <p style="color: #94a3b8 !important; font-size: 12px; margin: 16px 0 0 0;">
                              ...
                              <a href="${rescheduleLink}" style="color: #059669 !important; word-break: break-all;">${rescheduleLink}</a>
                            </p>
                          </td>
                        </tr>
                      </table>
