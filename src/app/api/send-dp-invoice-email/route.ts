                  ...
                  <tr>
                    <td bgcolor="#0f172a" style="background-color: #0f172a; padding: 32px 24px;">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                        <tr>
                          <td bgcolor="#0f172a" style="background-color: #0f172a; border: 1px solid #10b981; padding: 16px; border-radius: 4px; text-align: center;">
                            <p style="color: #94a3b8 !important; font-size: 14px; margin: 0 0 8px 0;">Total DP yang telah dibayar:</p>
                      ...
                      <p style="color: #94a3b8 !important; font-size: 14px; margin: 0 0 24px 0;">
