...
export async function POST(request: Request) {
  try {
    ...
    const { customerName, customerEmail, vehicleInfo, vehicleYear, serviceType, description, bookingDate } = body;
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: [customerEmail],
      subject: `Konfirmasi Reservasi Servis - ${customerName}`,
      html: `
        <!DOCTYPE html>
        ...
        <head>
          ...
          <title>Konfirmasi Reservasi Servis</title>
          <!--[if mso]>
          <noscript>
            <xml>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse;">
                  ...
                  <tr>
                    <td bgcolor="#0f172a" style="background-color: #0f172a; background-image: linear-gradient(#0f172a, #0f172a); padding: 32px 24px;">
                      ...
                      <p style="color: #94a3b8 !important; -webkit-text-fill-color: #94a3b8 !important; font-size: 15px; line-height: 1.6; margin: 0 0 24px 0;">Terima kasih telah melakukan reservasi di <strong style="color: #eab308 !important; -webkit-text-fill-color: #eab308 !important;">Scorpion Autoworks</strong>. Berikut adalah detail pesanan Anda:</p>
                        ...
                        <tr>
                          <td bgcolor="#1e293b" style="background-color: #1e293b; background-image: linear-gradient(#1e293b, #1e293b); border-left: 4px solid #eab308; padding: 16px; border-radius: 4px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 14px; color: #cbd5e1 !important; -webkit-text-fill-color: #cbd5e1 !important;">
                              ...
                              <tr><td style="padding: 4px 0; font-weight: bold; vertical-align: top; color: #94a3b8 !important; -webkit-text-fill-color: #94a3b8 !important;">Keluhan</td><td style="padding: 4px 0;">: ${description}</td></tr>
                            </table>
                          </td>
                        </tr>
                      </table>
                      ...
                      <p style="color: #f87171 !important; -webkit-text-fill-color: #f87171 !important; font-size: 14px; font-weight: bold; margin: 0 0 16px 0;">⚠️ Tolong harap datang lebih awal 15 menit sebelum jadwal yang ditentukan.</p>
                      
                      <p style="color: #94a3b8 !important; -webkit-text-fill-color: #94a3b8 !important; font-size: 14px; margin: 0 0 8px 0;">Berikut adalah alamat bengkel:</p>
    ...
    console.log('[send-email] Email sent successfully:', JSON.stringify(data, null, 2));
