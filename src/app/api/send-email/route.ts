                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse;">
                  ...
                  <tr>
                    <td bgcolor="#ffffff" style="background-color: #ffffff; padding: 32px 24px;">
                      ...
                      <p style="color: #475569 !important; -webkit-text-fill-color: #475569 !important; font-size: 15px; line-height: 1.6; margin: 0 0 24px 0;">Terima kasih telah melakukan reservasi di <strong style="color: #b45309 !important; -webkit-text-fill-color: #b45309 !important;">Scorpion Autoworks</strong>. Berikut adalah detail pesanan Anda:</p>
                        ...
                        <tr>
                          <td bgcolor="#ffffff" style="background-color: #ffffff; border-left: 4px solid #b45309; padding: 16px; border-radius: 4px; border: 1px solid #e2e8f0;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 14px; color: #334155 !important; -webkit-text-fill-color: #334155 !important;">
                              ...
                              <tr><td style="padding: 4px 0; font-weight: bold; vertical-align: top; color: #64748b !important; -webkit-text-fill-color: #64748b !important;">Keluhan</td><td style="padding: 4px 0;">: ${description}</td></tr>
                            </table>
                          </td>
                        </tr>
                      </table>
                      ...
                      <p style="color: #dc2626 !important; -webkit-text-fill-color: #dc2626 !important; font-size: 14px; font-weight: bold; margin: 0 0 16px 0;">⚠️ Tolong harap datang lebih awal 15 menit sebelum jadwal yang ditentukan.</p>
                      
                      <p style="color: #475569 !important; -webkit-text-fill-color: #475569 !important; font-size: 14px; margin: 0 0 8px 0;">Berikut adalah alamat bengkel:</p>
